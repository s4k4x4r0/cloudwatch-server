...
class CloudWatchServer {
    ...
    async handleListLogGroups(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to list log groups: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleListLogStreams(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to list log streams: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetLogEvents(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get log events: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async run() {
